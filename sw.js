...
const SHELL_ASSETS = ["/", "/index.html", "/style.css?v=2.3.7", "/cashier-themes.css?v=2.3.7", "/app-migration-v2.3.js?v=2.3.7", "/payroll-reminder.js?v=2.3.7", "/manifest.webmanifest", "/logo.png", "/icons/icon-192.png", "/icons/icon-512.png"];
